-- Create notifications table (without foreign key to notification_types for initial deployment)
...
-- Create basic notification types table first
...
-- Now add foreign key constraint to notification_types.type
ALTER TABLE ONLY "public"."notifications"
