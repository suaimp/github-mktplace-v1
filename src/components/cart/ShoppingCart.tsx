        ...
        <div className="flex flex-col h-full">
          ...
          <div className="border-t border-gray-200 dark:border-gray-800 p-4">
            <div className="flex justify-between text-base mb-4">
              <p className="font-bold text-gray-800 dark:text-white/90">Subtotal</p>
              <p className="font-bold text-gray-800 dark:text-white/90">{formatCurrency(totalPrice)}</p>
            </div>
            <Button
