              ...
              <div className="flex items-center gap-2 min-w-[140px]">
                ...
                <div className="flex items-center gap-2">
                  <img 
                    ...
                    className={`rounded-full ${country === 'ROW' ? 'dark:invert' : ''}`}
                  />
      ...
      {maxSelections && (
        <p className="text-sm text-gray-500 dark:text-gray-400">
          {selectedCount === maxSelections ? (
            <span className="text-warning-500">Máximo de {maxSelections} países selecionados</span>
          ) : (
            `Você pode selecionar até ${maxSelections} ${maxSelections === 1 ? 'país' : 'países'}`
          )}
        </p>
      )}
