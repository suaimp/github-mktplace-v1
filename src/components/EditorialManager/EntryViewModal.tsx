...
import { extractDomain, getFaviconUrl, getFlagUrl } from '../../components/form/utils/formatters';
...
export default function EntryViewModal({ isOpen, onClose, entry, isAdmin }: EntryViewModalProps) {
  ...
  const formatValue = (value: any, fieldType: string) => {
    ...
    // Skip button_buy fields in the view modal
      ...
      case 'product':
        try {
          ...
          if (typeof productData.price === 'string') {
            ...
            return originalPrice.startsWith('R$') ? originalPrice : `R$ ${originalPrice}`;
          } else {
          ...
          {entry.publisher && (
            <div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">
                <p>{entry.publisher.first_name} {entry.publisher.last_name}</p>
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {fields.map(field => {
                  ...
                  // Skip marketplace-only fields unless admin
