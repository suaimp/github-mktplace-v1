/**
 * Componente para exibir o conteúdo dos termos e condições
 * Responsabilidade única: renderizar o conteúdo HTML dos termos
 */
  ...
  return (
    <div className={`max-w-4xl mx-auto ${className}`}>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
        <div 
          className="terms-content prose prose-lg max-w-none dark:prose-invert 
