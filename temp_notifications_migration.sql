-- Create notifications table (modified to work without notification_types initially)
...
-- Skip foreign key constraint to notification_types for now
-- Will be added later after notification_types is created
-- ALTER TABLE ONLY "public"."notifications"
